...
export function ValueCardGrid({ items }: { items: ValueCardData[] }) {
  return (
    <div className="home-section-content-gap mx-auto grid w-full max-w-none items-stretch gap-4 min-[377px]:grid-cols-2 sm:gap-6 lg:max-w-[calc(100%-7rem)] lg:grid-cols-4 lg:gap-8">
