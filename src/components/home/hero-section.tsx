...
export function HeroSection() {
  ...
  return (
    <section className="relative isolate min-h-[82svh] overflow-hidden lg:min-h-[76svh] min-[1600px]:min-h-[80svh] min-[1920px]:min-h-[82svh]">
      ...
      <div aria-hidden="true" className="absolute inset-0 -z-10 bg-hero-vignette" />

      <div
        aria-hidden="true"
        className="absolute inset-0 -z-10 bg-gradient-to-r from-obsidian via-obsidian/76 to-obsidian/10"
      />
