          ...
          <div className="home-section-content-gap grid gap-4 md:grid-cols-3 lg:gap-5">
            {supportLinks.map((item, index) => (
              <FadeIn delay={index * 0.04} key={item.title}>
                <Link
                  className="group touch-card touch-card-lift touch-card-border-20 touch-card-surface-5 flex h-full items-start gap-4 rounded-lg border border-white/10 bg-white/[0.03] p-6 transition duration-300 ease-out hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.05] active:-translate-y-1 active:border-white/20 active:bg-white/[0.05] sm:p-7"
                  data-touch-card
                  href={item.href}
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <ArrowUpRight
                        aria-hidden="true"
                        className="touch-card-reveal flex-none text-white/50 opacity-0 transition group-hover:opacity-100 group-active:opacity-100"
                        size={16}
                      />
                    </div>
